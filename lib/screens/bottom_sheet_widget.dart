            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: state.listAllDice[index].runtimeType == AnonymousDice
                      ? index == 0 ? SuccessThresholdSlider(
                      value: state.successThreshold,
                      onChanged: (value) =>
                          context.read<DiceCubit>().changeSuccessThreshold(value))
                    : Column(
                  children: [
...
class RowDiceCounting extends StatelessWidget {
  const RowDiceCounting({super.key,
          ...
          children: [
            ...
            Align(
              ...
              child: /*Bounce*/ IconButton(
                onPressed: () =>
                    context.read<DiceCubit>().removeDiceInfinite(index),
                icon: const Icon(
      ...
      Expanded(
        child: Text(
            dice.runtimeType == DiceInfinite
                ...
                " ${context.read<DiceCubit>().countType(dice)}"
                : dice.runtimeType == DiceCustomSide
            ...
            style: defTs.copyWith(
                shadows: [], color: currentColor, overflow: TextOverflow.fade),
            textAlign: TextAlign.center),
      ),
      Row(
